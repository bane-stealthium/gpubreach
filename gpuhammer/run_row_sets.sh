...
# 23617854720
declare -A bank_map; bank_map[1257728]="C";

# declare -A bank_map; bank_map[0]=0; bank_map[256]='A'; bank_map[2048]='B'; bank_map[5120]='C'; bank_map[6400]='D';

for val in 1257728; do
  # python3 $HAMMER_ROOT/util/run_timing_task.py conf_set --range $((23 * (2 ** 30))) --size $((46 * (2 ** 30))) --it 15 --step 256 --threshold 27 --file $HAMMER_ROOT/results/row_sets/CONF_SET_${bank_map[$val]}.txt --trgtBankOfs $val
  # sleep 3s
